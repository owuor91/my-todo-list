...
//@Composable
//
//fun ToDosScreen(onClickToDos: (Int)-> Unit,
...
//                    items(todos!!){todos -> ToDosCard(todos, onClickToDos = onClickToDos) }
//                }
//            }
//
//        }
...
//            Text(text = toDos.title, fontWeight = FontWeight.Bold, fontSize = 30.sp, color = Color.Blue)
//            Spacer(Modifier.height(8.dp))
//            Text(text = toDos.completed,)
//
//        }
//    }
//}
